...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/04/2024 às 15:31
...
--
-- Estrutura para tabela `grupo_de_entrega`
--

CREATE TABLE `grupo_de_entrega` (
  `id` int(11) NOT NULL,
  `nome` varchar(255) NOT NULL,
  `descrição` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Índices de tabela `grupo_de_entrega`
--
ALTER TABLE `grupo_de_entrega`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `grupo_de_entrega`
--
ALTER TABLE `grupo_de_entrega`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
